...
const MeetingsOfTheDay = () => {
    ...
    return (
        <div className="meetingsOfTheDay-container">
            <h2>
                Meetings on{" "}
            ...
            {filteredMeetings.length === 0 ? (
                ...
                <ul className="meetingsOfTheDay-list">
                    {filteredMeetings.map((meeting) => (
                        <li key={meeting._id} className="meetingsOfTheDay-item">
                            <strong>Client:</strong> {meeting.client?.name}
                            <br />
                            <strong>Time:</strong>{" "}
                            {new Date(`1970-01-01T${meeting.time}:00`).toLocaleTimeString([], {
                                hour: "2-digit",
                                minute: "2-digit",
                            })}
                            <br />
